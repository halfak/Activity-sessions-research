...
ORDER BY RAND()
LIMIT 1000000;
CREATE UNIQUE INDEX rev_idx ON staging.intertime_revision_sample (rev_id);
...
INNER JOIN enwiki.revision prev ON
	prev.rev_user = irs.rev_user AND
	prev.rev_timestamp < irs.rev_timestamp
GROUP BY irs.rev_id;
