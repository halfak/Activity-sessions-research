...
email: {\texttt{morten@cs.umn.edu}}) and Anuradha Uduwage (GroupLens Researchg, email: {\texttt{uduwage@cs.umn.edu}}).}
...
\keywords{User session, Activity, Human behavior, Regularities, Metrics}
